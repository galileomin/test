<template>
    <div>
        <mt-swipe :auto="3000">
        <mt-swipe-item v-for="item in LbList" :key="item.path"> 
...
export default {
    data(){
        return{
            LbList:[
                {name:'1',path:'../src/images/1.jpg'},
                {name:'2',path:'../src/images/2.jpg'},
                {name:'3',path:'../src/images/3.jpg'},
                {name:'4',path:'../src/images/4.jpg'},
            ]  //保存轮播图的数组
        }
    },
    methods:{
